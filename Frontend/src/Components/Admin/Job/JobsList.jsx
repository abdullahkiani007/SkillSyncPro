...
const ManageJobs = () => {
  ...
  return (
    <div className='bg-gradient-to-r from-secondary-dark to-secondary-dark min-h-screen p-8 shadow-lg'>
      <h2 className='text-3xl font-semibold text-white mb-6'>Manage Jobs</h2>
      <div className='overflow-x-auto'>
        <table className='min-w-full bg-white rounder-lg  overflow-hidden'>
                  ...
                  <div className='flex items-center space-x-4'>
                    {!job.archived ? (
                      <button
                        ...
                        className='text-teal-500 hover:text-indigo-700 focus:outline-none'
                        title='Archive Job'
                      >

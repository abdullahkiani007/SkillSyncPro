...
function Sidebar({ sidebarOpen, setSidebarOpen, isAdmin }) {
  // State
  console.log("Sidee bar open = ", sidebarOpen);
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/employer/Dashboard" className="block">
            <img src={logo} alt="logo Skill Sync Pro" style={{ width: 150 }} />
          </NavLink>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Skill Assessment */}
              <SidebarLinkGroup activecondition={pathname.includes("skill")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a

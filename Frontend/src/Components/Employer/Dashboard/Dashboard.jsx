    ...
    <div className="min-h-screen bg-gray-100 p-10 ">
      ...
      {dashboardData && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-md" onClick={()=>{navigate("../company-profile")}} >
            ...
            <a href={dashboardData.company.website} target='_blank' className='text-green-800 text-sm'>Website: {dashboardData.company.website}</a>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md" onClick={()=>{navigate("../job/job-listing")}} >

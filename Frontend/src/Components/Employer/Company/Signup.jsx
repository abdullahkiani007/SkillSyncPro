...
import { Container,InputLabel, Typography, FormControl, FormLabel, RadioGroup, FormControlLabel, Radio, TextField, Button, MenuItem, Select } from '@mui/material';
      ...
      <form onSubmit={handleSubmit}>
        <FormControl component="fieldset">
          ...
          <RadioGroup row value={option} onChange={handleOptionChange}>
            <FormControlLabel value="join" control={<Radio />} label="Join a Company" />
            <FormControlLabel value="register" control={<Radio />} label="Register a Company" />
          </RadioGroup>
        </FormControl>

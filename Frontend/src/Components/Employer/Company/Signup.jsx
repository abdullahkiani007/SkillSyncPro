  ...
  return (
    <div className="bg-secondary-dark h-full min-h-screen p-10 flex justify-center items-center ">
      ...
      <div className="bg-white rounded-xl p-20 shadow-2xl ">
        <button className="absolute top-5 right-5 bg-primary text-white px-3 py-1 rounded-lg transition-transform transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary-light focus:ring-opacity-50">
          <Link to="/">
            <ArrowBack />
          </Link>
        </button>

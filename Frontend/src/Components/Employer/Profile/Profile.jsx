    ...
    <div className='w-full min-h-screen p-5 mb-10 bg-slate-400 flex flex-col items-center justify-center'>
      <div className='w-full lg:w-2/3 bg-white shadow-2xl rounded-3xl px-8 pt-10 pb-8 mb-4 relative'>
        ...
        <div className='mt-10'>
          ...
          <div className='bg-gray-50 mt-5 rounded-lg p-6'>
        ...
        <div className='mt-10 text-center'>
          <Button
            className='w-3/4 bg-slate-400 text-white py-3 rounded-full shadow-lg hover:shadow-2xl transform transition-transform duration-300 hover:scale-100 hover:from-secondary-dark hover:to-primary'
            variant='contained'
            onClick={() => {

  ...
  return (
    <nav className='flex py-10 px-10 md:px-40 bg-white  w-full justify-between items-center  z-10 fixed'>
      ...
      <ul
        ...
        } flex-col md:flex-row md:items-center absolute md:static top-full left-0 md:left-auto md:top-auto bg-white border rounded-md shadow-md py-2 md:py-0 md:shadow-none md:border-none w-full md:w-auto`}
      >

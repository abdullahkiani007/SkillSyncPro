  ...
  return (
    <div className="">
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`sticky flex flex-col z-40 left-0 top-0 
          h-screen overflow-y-auto no-scrollbar
           w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 
           shrink-0 bg-slate-800 p-4 transition-all 
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          {/* Logo */}
          <NavLink end to="/jobseeker/dashboard" className="block">
            <img
              src={logo}
              alt="Dashboard"
            ...
            <ul className="mt-3">
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("cv-builder") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                  ...
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      ...
                      <path
                        ...
                        d="M20 2H4a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2ZM4 0h16a4 4 0 0 1 4 4v16a4 4 0 0 1-4 4H4a4 4 0 0 1-4-4V4a4 4 0 0 1 4-4Zm8 14h-2v-2h2v2Zm0-4h-2V8h2v2Zm-4 4H6v-2h2v2Zm0-4H6V8h2v2Zm8 4h-2v-2h2v2Zm0-4h-2V8h2v2Z"
                      />
                    </svg>
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                      CV Builder
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("skill-builder") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                  to="skill-builder"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes("skill-builder")
                      ? "hover:text-slate-200"
                      : "hover:text-white"
                  }`}
                >
                  <div className="flex items-center">
                    <ComputerIcon className="shrink-0 h-6 w-6" />
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                      Skill Development
                    </span>
                  </div>

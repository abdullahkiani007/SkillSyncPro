...
function Jobs() {
  ...
  const filterJobs = () => {
    ...
    if (applicants) {
      filtered = filtered.filter((job) => job.applicants.length <= parseInt(applicants));
    }
      ...
      <div className="p-5">
        ...
        <div className="p-5 rounded-lg shadow-md">
          <div className="flex justify-between items-center mb-5">
            ...
            <div className="text-lg font-bold">{(showRecommended ? recommendedJobs.length : filteredJobs.length) || 0}</div>
          </div>

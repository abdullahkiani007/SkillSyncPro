...
EmployerRouter.delete(
  "/company/leave",
  passport.authenticate("jwt", { session: false }),
  companyController.leaveCompany
);
EmployerRouter.put(
  "/company/employee/authorize",
  passport.authenticate("jwt", { session: false }),
  companyController.authorizeEmployee
);
EmployerRouter.delete(
  "/company/employee/revoke",
  passport.authenticate("jwt", { session: false }),
  companyController.revokeEmployee
);
EmployerRouter.delete(
  "/company/employee/JoinRequest",
  passport.authenticate("jwt", { session: false }),
  companyController.deleteJoinRequest
);

EmployerRouter.post(
  "/assessment",
  passport.authenticate("jwt", { session: false }),
  employerController.createAssessment
);
EmployerRouter.get(
  "/assessments",
  passport.authenticate("jwt", { session: false }),
  companyController.getAssessment
);
EmployerRouter.get(
  "/assessment",
  passport.authenticate("jwt", { session: false }),
  employerController.getAssessmentById
);
EmployerRouter.put(
  "/assessment",
  passport.authenticate("jwt", { session: false }),
  employerController.editAssessment
);
EmployerRouter.delete(
  "/assessment",
  passport.authenticate("jwt", { session: false }),
  employerController.deleteAssessment
);
...
EmployerRouter.get(
  "/applicationsStatus",
  passport.authenticate("jwt", { session: false }),
  employerController.getApplicationsGrouptedByStatus
);
EmployerRouter.get(
  "/candidates",
  passport.authenticate("jwt", { session: false }),
  employerController.getAllCandidates
);
EmployerRouter.get(
  "/candidates/job",
  passport.authenticate("jwt", { session: false }),
  employerController.getCandidatesByJobId
);
...
EmployerRouter.put(
  "/application/stage",
  passport.authenticate("jwt", { session: false }),
  employerController.updateApplicationStage
);
...
EmployerRouter.post(
  "/note",
  passport.authenticate("jwt", { session: false }),
  employerController.createJobNote
);
...
EmployerRouter.get(
  "/note/:jobId",
  passport.authenticate("jwt", { session: false }),
  employerController.getNotesForJob
);

...
const CompanyController = {
  ...
  async authorizeEmployee(req, res, next) {
    ...
    try {
      const response = await companyService.authorizeEmployee(
        employeeId,
        id,
        companyId
      );
  ...
  async revokeEmployee(req, res, next) {
    ...
    try {
      const response = await companyService.revokeEmployee(
        employeeId,
        id,
        companyId
      );
  ...
  async deleteJoinRequest(req, res, next) {
    ...
    try {
      const response = await companyService.deleteJoinRequest(
        employeeId,
        id,
        companyId
      );

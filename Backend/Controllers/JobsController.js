...
const JobsController = {
    ...
    async trackJobView(req, res) {
        ...
        try {
            ...
            return res.status(200).json({ message: 'Job view tracked successfully.' });
        } catch (error) {
            return res.status(500).json({ error: error.message });
        }
    },
    ...
    async trackJobApplication(req, res) {
        ...
        try {
            ...
            return res.status(200).json({ message: 'Job application tracked successfully.' });
        } catch (error) {
            return res.status(500).json({ error: error.message });
        }
    },
    ...
    async trackJobHire(req, res) {
        ...
        try {
            ...
            return res.status(200).json({ message: 'Job hire tracked successfully.' });
        } catch (error) {
            return res.status(500).json({ error: error.message });
        }
    },
    ...
    async getJobPerformance(req, res) {
        ...
        try {
            const performance = await Job.getJobPerformance(jobId, new Date(startDate), new Date(endDate));
